...
There’s also a thin layer of weekly notes that provide context — not as long‑term knowledge, but as a way to remember _when_ something happened.
...
In both cases, the goal is the same: not to preserve the original conversation, but to capture what it _means_.
