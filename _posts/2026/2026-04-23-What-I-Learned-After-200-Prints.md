...
Back then, as [I wrote in the middle of my beginner‑euphoria](https://matthiaskarner.com/2026/02/3D-Printing/), I looked at the world through bright pink glasses. But like with anything new, the novelty fades. Once it did, something happened: I stopped seeing 3D printing as a fun toy and started seeing it more as a tool.
...
Examples for such models are: [FlexiRex](https://makerworld.com/en/models/103585-flexi-rex-with-stronger-links?from=search#profileId-113955), [Infinity Cube](https://makerworld.com/en/models/65426-fidget-cube-toy-angled?from=search#profileId-68762), [ArcSpin](https://makerworld.com/en/models/2278739-arcspin-print-it-spin-it?from=search#profileId-2484817), …
...
You can even take it a step further and create connectors between different types of toys: the [Duplo-Brio-Connector](https://makerworld.com/en/models/1341998-wooden-train-track-duplo-adaptor?from=search#profileId-2404762) is a great example for that in my opinion. This is where 3D printing shines: creating objects you can’t even buy.
...
- Accessories for Ikea Skadis: e.g. [hooks](https://makerworld.com/en/models/23592-ikea-skadis-hook?from=search#profileId-28439), [containers](https://makerworld.com/en/models/135571-ikea-skadis-container-d60-h25?from=search#profileId-147360), [quick-release clip](https://makerworld.com/en/models/1012679-skadis-quick-release-photo-clip?from=search#profileId-992285), …
- My charging wall: I combined a [multi-phone holder](https://makerworld.com/en/models/1967700-skadis-ikea-pegboard-phone-holder-with-a-bottom-sl?from=search#profileId-2115505) with accessories for cable management a holder for a power strip on a miniature Skadis pegboard to keep my family’s charging needs organized
- Accessories for organization in the car: I printed a lot of accessories reaching from a [phone holder](https://makerworld.com/en/models/414591-audi-a3-8p-phone-holder?from=search#profileId-316771) suitable for my car to paper baskets and fitted organization boxes.
...
Honestly, I might do that at some point, but as an addition. With 3D printing I found a great way of creating things, making ideas live. It might be the beginning of something …