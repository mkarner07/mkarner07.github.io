...
Two weeks ago, I wrote an article about [proven ways how generative AI can boost your productivity](https://matthiaskarner.com/2025/12/Proven-Ways-Generative-AI-Can-Boost-Your-Productivity). That post focused more on the *why* than the *how*. Today, I’ll share the *how*: my personal workflows for using **Microsoft Copilot** every day to stay productive as a department head.
...
I’ve been obsessed with knowledge management for a couple of years now. After experimenting with [GTD](https://matthiaskarner.com/2023/11/The-Total-Recall-Productivity-Method/), [Zettelkasten](https://niklas-luhmann-archiv.de/), and [Second Brain & PARA](https://fortelabs.com/blog/para/), I eventually built my own productivity-notetaking-knowledge-base-system system. Back in 2023, I called it [TORP](https://matthiaskarner.com/2023/11/The-Total-Recall-Productivity-Method/). It has evolved since then, but I still use most of its components every day.
...
Let’s connect and exchange thoughts on [LinkedIn](https://www.linkedin.com/in/matthiaskarner/)!